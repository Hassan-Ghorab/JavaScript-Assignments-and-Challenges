/*
// Assignments For Lessons 115 To 121
*/
...
console.log(`My Skills are: ${a}, ${b}, ${c}, ${d}, ${e}, ${f}, ${g}`);
// My Skills are: HTML, CSS, JavaScript, PHP, Python, Django, Laravel
*/
...
// My Best Friends are: Shady, Mahmoud, Ahmed
*/
